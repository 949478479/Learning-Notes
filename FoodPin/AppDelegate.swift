...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func configureAppearance() {
        ...
        UINavigationBar.appearance().titleTextAttributes = [
            ...
            NSFontAttributeName: UIFont(name: "AvenirNextCondensed-DemiBold", size: 22)! ]

        UINavigationBar.appearance().tintColor = UIColor.whiteColor()

        UINavigationBar.appearance().barTintColor =
            UIColor(red: 231/255, green: 95/255, blue: 53/255, alpha: 0.3)

        UIToolbar.appearance().barTintColor =
            UIColor(red: 237/255, green: 240/255, blue: 243/255, alpha: 0.5)
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        ...
        This code uses a directory named "com.cjyh.FoodPin" in the application's documents
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
        ...
        application to it. This property is optional since there are legitimate error conditions 
